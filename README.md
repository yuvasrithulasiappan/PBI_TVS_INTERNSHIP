...
The manufacturing process is stage-based (Quotation, Confirmation, Engine Setup, Body Setup, Final Assembly, QC, Delivery Start, Delivered), and each order can take 30-45 days to complete. The business wants to track delays, dealer performance, customer behavior, and model-wise trends using Power BI.
